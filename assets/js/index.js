...
var toggleLoading = __webpack_require__(403);
var getQuote = __webpack_require__(404);
var getImage = __webpack_require__(405);
var appendQuote = __webpack_require__(406);
var appendImage = __webpack_require__(407);
...
module.exports = function () {
  ...
  function appendQuoteAndImage() {
    return _ref.apply(this, arguments);
  }

  return appendQuoteAndImage;
}();
...
module.exports = !__webpack_require__(55) && !__webpack_require__(150)(function () {
...
module.exports = function getImage(queryString) {
  var formattedQuery = queryString.replace(/ /g, '_');

  return fetch('https://api.giphy.com/v1/gifs/search?q=' + formattedQuery + '&api_key=inPBzYRrnBFaRTyTrSSRpD21B4HEO5xT').then(function (res) {
    return res.json();
  }).then(function (json) {
...
var makeImageURI = __webpack_require__(408);
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 5:
                        blob = _context.sent;
                        return _context.abrupt("return", _promise2.default.resolve(URL.createObjectURL(blob)));
